...
go
insert into NHANVIEN values (N'Nguyễn',N'thị',N'Thắm','020',cast('1967-10-20' as date),N'230 Lê Văn Sỹ,TP HCM','Nam',30000,'010',4)
--------Câu1_b)-------------------
...
go
insert into NHANVIEN values (N'Lê',N'Văn',N'An','011',cast('1970-10-20' as date),N'200 Lê Văn Sỹ,TP HCM','Nam',300000,'011',4)
----------------------Câu 1_c----------------
...
INSERT INTO NHANVIEN VALUES ('Lê','Xuân','Trường','033','7-12-1999','TP HCM','Nam',60000,'003',1)
GO
 --------Câu2_b--------------------
...
INSERT INTO NHANVIEN VALUES ('Lê','Xuân','Khang','031','7-12-1999','Hà nội','Nam',60000,'003',1)